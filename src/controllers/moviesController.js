...
exports.getAll = async (req, res) => {
  ...
  try {
    const results = await movieModel.findAll(dataLimit, offset, search, by, sort)
    const nextResults = await movieModel.findAll(dataLimit, offset + dataLimit, search, by, sort)
